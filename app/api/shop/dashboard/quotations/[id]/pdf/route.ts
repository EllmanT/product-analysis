...
export async function GET(
  ...
  try {
    ...
    page.drawText(`#${refId}`, {
      x: 40, y: height - 60, font: regular, size: 11, color: rgb(0.576, 0.765, 0.988),
    });
    ...
    page.drawText(totalVal, {
      ...
      y: totalsY - 28, font: bold, size: 13, color: blue,
    });
    ...
    page.drawText(footerLine1, {
      ...
      y: footerH - 18, font: regular, size: 10, color: grayText,
    });
