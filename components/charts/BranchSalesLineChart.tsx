...
import { Download, LucidePrinter, Printer, PrinterIcon, SheetIcon } from "lucide-react"
...
export function BranchSalesLineChart() {
...
>
         ...
         <Button
  className="primary-gradient h-9 px-3 py-1 text-sm !text-light-900 bg-red-700"
>
          <Printer/>
          <Link href="/">PDF</Link>
        </Button>
